 ...
 *
 */
namespace Piwik\Plugins\MyAnalyticsPlugin\Widgets;
 ...
 */
class GetSocialMedia extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId('My Analytics Plugin');
         ...
         */
        $config->setName('Social Media Reactinos');
    ...
    public function render()
    {
        ...
        // Enviar datos consultados con el api de las redes a la vista del widget para mostrarlos al usuario
        return $this->renderTemplate('socialmediareactions.twig', array('allData'=>$uniqueAllData));

        //return '<div class="mysocialmediabody"><h1>Social Media Sumary:</h1><br></div>';
    }
